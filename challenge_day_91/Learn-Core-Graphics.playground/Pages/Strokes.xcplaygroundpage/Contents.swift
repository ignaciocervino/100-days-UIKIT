...
let rendered = renderer.image { ctx in
    ...
    rects.append(CGRect(x: 100, y: 400, width: 200, height: 200))
    rects.append(CGRect(x: 700, y: 400, width: 200, height: 200))
    rects.append(CGRect(x: 400, y: 100, width: 200, height: 200))
    rects.append(CGRect(x: 400, y: 700, width: 200, height: 200))

    for i in 0..<rects.count {
        ctx.cgContext.addEllipse(in: rects[i])
        ctx.cgContext.drawPath(using: .fillStroke)
    }

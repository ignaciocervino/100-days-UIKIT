...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        physicsWorld.gravity = CGVector(dx: 0, dy: -6) // Stay a little big longer
    ...
    func playSwooshSound() {
        ...
        run(swooshSound) { [weak self] in
            self?.isSwooshSoundActive = false // When the sound ends we set it to false
        }
    }
